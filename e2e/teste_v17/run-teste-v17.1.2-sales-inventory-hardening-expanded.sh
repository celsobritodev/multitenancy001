...
COLLECTION="${SCRIPT_DIR}/multitenancy001.postman_collection.v17.1.2.sales-inventory-hardening-expanded.strict.json"
ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v17.1.2.sales-inventory-hardening-expanded.strict.json"
...
echo "────────────────────────────────────────"
echo "🔷 TESTE V17.1.2 - SALES + INVENTORY HARDENING EXPANDED (STRICT SUITE)"
...
title "Executando testes (SALES + INVENTORY HARDENING EXPANDED STRICT)"
