...
# =========================================================
# TESTE V13.0 - VERSÃO ULTRA (ENTERPRISE + INVENTORY)
# =========================================================
# Características:
...
# - Testes específicos de inventory, sales impact e tenant isolation
# =========================================================
...
LOG_FILE="${LOG_DIR}/execucao_v13.0_${TIMESTAMP}.log"
...
run_newman() {
    title "Executando Newman - ENTERPRISE + INVENTORY"
...
generate_report() {
    ...
    {
        echo "╔════════════════════════════════════════════════════════════╗"
        echo "║      RELATÓRIO DE TESTES V12.6 - ENTERPRISE + INVENTORY        ║"
        echo "╚════════════════════════════════════════════════════════════╝"
        echo ""
...
main() {
    ...
    hr
    echo -e "${WHITE}🔷 TESTE V13.0 - ENTERPRISE + INVENTORY (VERSÃO ULTRA ROBUSTA)${RESET}"
