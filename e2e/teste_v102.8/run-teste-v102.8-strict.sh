...
mkdir -p "${LOG_DIR}"
COLLECTION="${SCRIPT_DIR}/collection.v102.8.final.chaos.calibrado.json"
ENV_FILE="${SCRIPT_DIR}/environment.v102.8.final.json"
...
hr
title "TESTE V102.8 FINAL CHAOS CALIBRADO - STRICT SUITE"
