...
COLLECTION="${SCRIPT_DIR}/collection.v100.9.json"
ENV_FILE="${SCRIPT_DIR}/environment.v100.9.json"
...
trap cleanup EXIT
echo "────────────────────────────────────────────────────"
echo "🔷 TESTE V100.9 HEAVY DATA POPULATION GRID QUERY HARDENING - STRICT SUITE"
