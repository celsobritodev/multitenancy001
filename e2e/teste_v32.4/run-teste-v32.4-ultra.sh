...
COLLECTION="${SCRIPT_DIR}/multitenancy001.postman_collection.v32.4.sales-fixed.json"
ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v32.4.sales-fixed.json"
