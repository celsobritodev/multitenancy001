...
echo "────────────────────────────────────────────────────"
echo "🔷 TESTE V24.1 TRANSACTIONAL HARDENING PATCHED (ULTRA SUITE)"
...
detail "V24.0 mantém tudo da V23.2 e endurece o agregador de chaos usando correções defensivas adicionais."
