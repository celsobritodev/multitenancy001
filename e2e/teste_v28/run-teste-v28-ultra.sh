...
COLLECTION="${SCRIPT_DIR}/multitenancy001.postman_collection.v28.cancel-return-reversal-grid.json"
ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v28.cancel-return-reversal-grid.json"
...
echo "────────────────────────────────────────────────────"
echo "🔷 TESTE V28 CANCEL / RETURN / REVERSAL GRID (ULTRA SUITE)"
...
title "Executando suíte base V28"
...
hr
title "V28 - Observação"
detail "A V28 evolui a V27 e amplia o Distributed Chaos com multi-product contention, cross-node chaos, transaction abort, replay, ledger rebuild e snapshot drift detector."
