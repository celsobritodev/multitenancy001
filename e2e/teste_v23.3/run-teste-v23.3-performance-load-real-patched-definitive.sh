...
echo "────────────────────────────────────────────────────"
echo "🔷 TESTE V23.3 STRICT HARDENED CORRIGIDA - DEV SUITE"
...
ok "TESTE V23.3 STRICT HARDENED CORRIGIDA FINALIZADO"
title "V23.3 - Observação"
detail "Esta versão strict herda o modelo operacional da ultra: porta limpa, reset de banco, boot limpo e execução sempre determinística."
detail "A correção principal remove o modo 'reaproveitar app já rodando', que era a causa mais provável dos 401 em cascata na strict."
