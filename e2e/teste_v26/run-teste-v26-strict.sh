...
COLLECTION="${SCRIPT_DIR}/multitenancy001.postman_collection.v26.0.distributed-chaos.json"
ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v26.0.distributed-chaos.json"
...
echo "────────────────────────────────────────────────────"
echo "🔷 TESTE V26 DISTRIBUTED CHAOS - STRICT SUITE"
