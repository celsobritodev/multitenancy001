...
echo "────────────────────────────────────────────────────"
echo "🔷 TESTE V25.3 DETERMINISTIC CHAOS ENGINE PATCHED - STRICT SUITE"
...
ok "TESTE V25.3 DETERMINISTIC CHAOS ENGINE PATCHED FINALIZADO"
title "V25.3 - Observação"
detail "A V25.2 mantém integralmente o modelo operacional da V24.1: porta limpa, reset de banco, boot limpo e execução determinística."
