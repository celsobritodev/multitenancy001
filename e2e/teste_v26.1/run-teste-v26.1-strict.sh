...
COLLECTION="${SCRIPT_DIR}/multitenancy001.postman_collection.v26.1.distributed-chaos-telemetry-fix.json"
ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v26.1.distributed-chaos-telemetry-fix.json"
