...
ALT_COLLECTION="${SCRIPT_DIR}/multitenancy001.postman_collection.v100.7.enterprise-data-population-grid.hardened.strict.json"
ALT_COLLECTION="${SCRIPT_DIR}/multitenancy001.postman_collection.v100.7.enterprise-data-population-grid.hardened.strict.json"
ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v100.heavy-data-population-grid.json"
ALT_ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v100.7.enterprise-data-population-grid.hardened.strict.json"
ALT_ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v100.7.enterprise-data-population-grid.hardened.strict.json"
...
trap cleanup EXIT
echo "────────────────────────────────────────────────────"
echo "🔷 TESTE V100.7 HEAVY DATA POPULATION GRID HARDENED - STRICT SUITE"
