...
# =========================================================
# TESTE V12.6 - VERSÃO SIMPLES (CUSTOMERS + SALES)
# =========================================================
...
run_tests() {
    title "Executando testes (CUSTOMERS + SALES)"
...
main() {
    hr
    title "TESTE V12.6 - CUSTOMERS + SALES (VERSÃO SIMPLES)"
    hr
