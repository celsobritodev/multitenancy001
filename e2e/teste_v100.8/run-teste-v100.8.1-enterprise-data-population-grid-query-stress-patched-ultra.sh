...
if [[ -f "${SCRIPT_DIR}/run-teste-v100.8.1-enterprise-data-population-grid-query-stress-patched-strict.sh" ]]; then
  bash "${SCRIPT_DIR}/run-teste-v100.8.1-enterprise-data-population-grid-query-stress-patched-strict.sh"
else
