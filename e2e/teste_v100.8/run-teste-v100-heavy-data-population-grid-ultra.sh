...
if [[ -f "${SCRIPT_DIR}/run-teste-v100.8-enterprise-data-population-grid-query-stress-strict.sh" ]]; then
  bash "${SCRIPT_DIR}/run-teste-v100.8-enterprise-data-population-grid-query-stress-strict.sh"
else
