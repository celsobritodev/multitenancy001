...
COLLECTION="${SCRIPT_DIR}/multitenancy001.postman_collection.v32.1.hardening-real-stabilized.json"
ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v32.1.hardening-real-stabilized.json"
