...
COLLECTION="${SCRIPT_DIR}/multitenancy001.postman_collection.v32.9.1.final.json"
ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v32.9.1.final.json"
