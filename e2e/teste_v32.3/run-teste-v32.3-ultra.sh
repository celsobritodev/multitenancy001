...
COLLECTION="${SCRIPT_DIR}/multitenancy001.postman_collection.v32.3.final-limpa.json"
ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v32.3.final-limpa.json"
