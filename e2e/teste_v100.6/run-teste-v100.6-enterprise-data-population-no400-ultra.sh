...
if [[ -f "${SCRIPT_DIR}/run-teste-v100.6-enterprise-data-population-no400-strict.sh" ]]; then
  bash "${SCRIPT_DIR}/run-teste-v100.6-enterprise-data-population-no400-strict.sh"
else
