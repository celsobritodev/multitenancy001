...
ALT_COLLECTION="${SCRIPT_DIR}/multitenancy001.postman_collection.v100.6.enterprise-data-population-no400.strict.json"
ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v100.heavy-data-population-grid.json"
ALT_ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v100.6.enterprise-data-population-no400.strict.json"
...
trap cleanup EXIT
echo "────────────────────────────────────────────────────"
echo "🔷 TESTE V100.6 HEAVY DATA POPULATION GRID - STRICT SUITE"
