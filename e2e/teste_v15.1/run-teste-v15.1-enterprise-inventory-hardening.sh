...
COLLECTION="${SCRIPT_DIR}/multitenancy001.postman_collection.v15.1.enterprise-inventory-hardening.strict.json"
ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v15.1.enterprise-inventory-hardening.strict.json"
...
echo "────────────────────────────────────────"
echo "🔷 TESTE V15.1 - ENTERPRISE + INVENTORY HARDENING (STRICT SUITE)"
...
title "Executando testes (ENTERPRISE + INVENTORY HARDENING STRICT)"
