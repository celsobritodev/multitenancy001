...
LOG_FILE="${LOG_DIR}/execucao_v17.1_${TIMESTAMP}.log"
...
title "Executando Newman - SALES + INVENTORY HARDENING EXPANDED STRICT"
...
{
  echo "╔════════════════════════════════════════════════════════════╗"
  echo "║ RELATÓRIO DE TESTES V17.1.2 - SALES + INVENTORY HARDENING EXPANDED (STRICT) ║"
  echo "╚════════════════════════════════════════════════════════════╝"
  echo ""
