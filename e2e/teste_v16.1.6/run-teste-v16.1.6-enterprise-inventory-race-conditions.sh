...
COLLECTION="${SCRIPT_DIR}/multitenancy001.postman_collection.v16.1.6.enterprise-inventory-race-conditions.strict.json"
ENV_FILE="${SCRIPT_DIR}/multitenancy001.local.postman_environment.v16.1.6.enterprise-inventory-race-conditions.strict.json"
...
echo "────────────────────────────────────────"
echo "🔷 TESTE V16.1.6 - ENTERPRISE + INVENTORY RACE CONDITIONS (STRICT SUITE)"
...
step "Encerrando conexões do banco db_multitenancy"
...
title "Executando testes (ENTERPRISE + INVENTORY RACE CONDITIONS STRICT)"
