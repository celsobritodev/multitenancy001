...
LOG_FILE="${LOG_DIR}/execucao_v16.1.6_${TIMESTAMP}.log"
...
title "Executando Newman - ENTERPRISE + INVENTORY RACE CONDITIONS STRICT"
...
{
  echo "╔════════════════════════════════════════════════════════════╗"
  echo "║ RELATÓRIO DE TESTES V16.1.6 - ENTERPRISE + INVENTORY RACE CONDITIONS (STRICT) ║"
  echo "╚════════════════════════════════════════════════════════════╝"
  echo ""
