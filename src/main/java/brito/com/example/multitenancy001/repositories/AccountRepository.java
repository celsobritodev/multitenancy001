...
public interface AccountRepository extends JpaRepository<Account, Long> {
    ...
    Optional<Account> findBySchemaName(String schemaName);
    ...
    List<Account> findExpiredTrials(
            @Param("date") LocalDateTime date,
            @Param("status") AccountStatus status);  // ✅ CORRIGIDO: Usando parâmetro
    ...
    List<Account> findOverdueAccounts(
            ...
            @Param("today") LocalDateTime today);  // ✅ CORRIGIDO: Usando parâmetro
