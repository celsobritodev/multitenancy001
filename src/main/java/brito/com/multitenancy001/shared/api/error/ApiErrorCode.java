 ...
 * - httpStatus é o status padrão (pode ser sobrescrito pelo ApiException legado)
...
public enum ApiErrorCode {
     ...
     * Ex.: "account_not_found" -> ACCOUNT_NOT_FOUND (se existir).
     */
    public static Optional<ApiErrorCode> tryParse(String legacyCode) {
        ...
        String normalized = legacyCode.trim().toUpperCase(Locale.ROOT);
        try {
