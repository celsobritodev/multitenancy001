...
public class UserTenant {
	...
	@ElementCollection
	@CollectionTable(name = "user_tenant_permissions", // ⚠️ TABELA SEPARADA
	...
	private void addDefaultPermissions() {
		...
		if (this.permissions.isEmpty()) {
			...
			switch (this.role) {
			case TENANT_ADMIN -> permissions.addAll(List.of("USER_CREATE", "USER_UPDATE", "USER_DELETE", "USER_VIEW",
					"PRODUCT_CREATE", "PRODUCT_UPDATE", "PRODUCT_DELETE", "PRODUCT_VIEW", "SALE_CREATE", "SALE_UPDATE",
					"SALE_DELETE", "SALE_VIEW", "REPORT_VIEW", "SETTINGS_MANAGE"));
			case MANAGER -> permissions.addAll(List.of("PRODUCT_CREATE", "PRODUCT_UPDATE", "PRODUCT_VIEW",
					"SALE_CREATE", "SALE_VIEW", "REPORT_VIEW"));
			case VIEWER -> permissions.addAll(List.of("USER_VIEW", "PRODUCT_VIEW", "SALE_VIEW", "REPORT_VIEW"));
			case USER -> permissions.addAll(List.of("VIEW_BASIC"));
			default -> {
