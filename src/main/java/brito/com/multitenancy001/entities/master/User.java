...
public class User {
	...
	// @Pattern(regexp = ValidationPatterns.PASSWORD_PATTERN, message = "Senha
	// fraca.")
	...
	@ElementCollection
	@CollectionTable(name = "user_permissions", joinColumns = @JoinColumn(name = "user_id"), uniqueConstraints = @UniqueConstraint(columnNames = {
			"user_id", "permission" }))
	...
	private void addDefaultPermissions() {
		...
		if (this.permissions.isEmpty()) {
			...
			case ADMIN:
				this.permissions.addAll(List.of("ACCOUNT_MANAGE", "USER_CREATE", "USER_UPDATE", "USER_DELETE",
						"USER_VIEW", "PRODUCT_CREATE", "PRODUCT_UPDATE", "PRODUCT_DELETE", "PRODUCT_VIEW",
						"SALE_CREATE", "SALE_UPDATE", "SALE_DELETE", "SALE_VIEW", "SUPPLIER_CREATE", "SUPPLIER_UPDATE",
						"SUPPLIER_DELETE", "SUPPLIER_VIEW", "REPORT_VIEW", "SETTINGS_MANAGE"));
				break;

			case PRODUCT_MANAGER:
				this.permissions.addAll(List.of("PRODUCT_CREATE", "PRODUCT_UPDATE", "PRODUCT_DELETE", "PRODUCT_VIEW",
						"SUPPLIER_VIEW", "REPORT_VIEW"));
				break;

			case SALES_MANAGER:
				this.permissions
						.addAll(List.of("SALE_CREATE", "SALE_UPDATE", "SALE_VIEW", "PRODUCT_VIEW", "REPORT_VIEW"));
				break;
	...
	public boolean hasPermission(String permission) {
		return this.permissions.contains(permission) || this.permissions.contains("ALL") || this.role.isAdmin(); // ✅
																													// Usando
																													// método
																													// do
																													// enum
